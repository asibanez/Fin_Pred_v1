...
value_counts = pd.value_counts(trna_scores_df.id)[0:100]



#%% Visualize scores and news text
id_trna = 'tr:BwvhSjXa__20060120IxnKHu669WRG0XfHHxLXAM3gMpzEhkoANPx7'
id_news = id_trna.split(':')[1]

trna_news_df[trna_news_df.id == id_trna]
trna_news_df.loc[2200]

trna_scores_df[trna_scores_df.id == id_trna]
trna_scores_df.loc[2574]
trna_scores_df.loc[2575]
trna_scores_df.loc[2576]
