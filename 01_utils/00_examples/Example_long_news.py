...
id_trna = 'tr:L8N2DE1CL_2006016elJ55D2LWfAsv5H68Kas9oEf3/mAC3HSNfR6s'
id_news = id_trna.split(':')[1]

trna_news_df[trna_news_df.id == id_trna]
trna_news_df.loc[1925]

trna_scores_df[trna_scores_df.id == id_trna]
trna_scores_df.loc[2243]
trna_scores_df.loc[2244]
trna_scores_df.loc[2245]

news_df[news_df['data.id'] == id_news]
news_df.loc[6810]

#%% Print headline and body
body = news_df.loc[6810]['data.body']
headline = news_df.loc[6810]['data.headline']
print(f'HEADLINE =====================\n\n{headline}\n')
print(f'BODY =====================\n\n{body}\n')
